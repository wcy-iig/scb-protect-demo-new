    ...
    <div class="nmaxs">
      <div class="tac-container-1">
        <div class="nav-max-inner">
          <a href="online_premium_cal.blade.php" class="nmaxs__logo">
  ...
  <div class="nav-min">
    <div class="nav-min-sticky nms">
      <div style="display: flex; justify-content: space-between; width: 100%;">
        <a href="online_premium_cal.blade.php" class="nms__logo">
          <img src="assets/img/logo-scb-protect-long.png" alt="SCB Protect Logo">
        </a>
        <div class="progressbox">
          <ul class="progressbar">
      ...
      <div class="tac-container-1 color-primary">
        ...
        <div id="formBuyInsurance">
          <div class="grid1">
            ...
            <div class="col-lg-4 col-12">
              ...
              <div class="box-purple-custom color-primary">
                ...
                <h5>ความคุ้มครอง ประกันภัยสุขภาพและอุบัติเหตุ Viriyah Healthcare by BDMS<br class="d-fhd-block d-none">
          ...
          <div class="buttons text-center" style="margin-top: 60px;">
            <a class="btn btn-step btn-outline-primary mr-sm-4 mr-0 mb-fhd-0 mb-4" href="online_personal_question.blade.php">
              <span class="btn-text">ย้อนกลับ</span>
            </a>
            <a class="btn btn-step btn-secondary" href="online_purchase_success.blade.php">
