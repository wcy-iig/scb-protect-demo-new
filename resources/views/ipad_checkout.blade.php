        ...
        <div class="tac-container-1">
          <div class="nav-max-inner">
            <a class="btn btn-back-custom" href="ipad_premium_cal">
              ...
              <div style="display: inline-block; font-size: 18px;">คำนวณเบี้ยประกัน</div>
            </a>
    ...
    <div class="nav-min">
      <div class="nav-min-sticky nms align-items-center">
        <div style="display: flex; justify-content: space-between; width: 100%;">
          <a class="btn btn-back-custom" href="ipad_premium_cal" style="height: 43px; padding: .25rem 0; min-width: 72px;">
            <img src="assets/img/icons8_back.png" width="42px" style="display: inline-block;">
          </a>
          ...
          <div id="formBuyInsurance">
            <div class="grid1">
              <div class="col-lg-8 col-12">
                ...
                <hr class="break d-none">

                <div id="payment-credit" class="d-none">
            ...
            <div class="buttons text-center" style="margin-top: 60px;">
              <a class="btn btn-step btn-secondary" href="ipad_purchase_success">
