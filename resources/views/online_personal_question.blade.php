        ...
        <div id="formBuyInsurance" class="grid1">
          <div class="col-lg-10 offset-lg-1 col-12">
            ...
            <div class="buttons text-center" style="margin-top: 70px;">
              <a class="btn btn-step btn-outline-primary mr-sm-4 mr-0 mb-fhd-0 mb-4" href="online_health_question.blade.php">
                <span class="btn-text">ย้อนกลับ</span>
              </a>
              <a class="btn btn-step btn-secondary" href="online_checkout.blade.php">
