    ...
    <section class="section-main">
      <div class="tac-container-1 color-primary">
        ...
        <div class="buttons text-center">
          <a class="btn btn-step btn-outline-primary mr-sm-4 mr-0 mb-fhd-0 mb-4" href="online_premium_cal.blade.php">
            <span class="btn-text">ย้อนกลับ</span>
          </a>
          <a class="btn btn-step btn-secondary" href="online_personal_question.blade.php">
