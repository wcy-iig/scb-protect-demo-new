        ...
        <div class="scroll-content">
            <div class="scroll-content-inner">
                ...
                <section class="sec-buy-insurance">
                    <div class="tac-container-1">
                        <a href="Website-FNA-03" class="back" style="position: absolute;"><img src="assets/icon-back.png"></a>
                    ...
                    <div class="tac-container-2 form-buy-ins-cnt">
                        <h2 class="title-section">สถานภาพปัจจุบันเป็นอย่างไรคะ?</h2>
                        <form id="formBuyInsurance" novalidate="novalidate" class="text-center">
                            <div class="form-group col-12 col-lg-6" style="margin: 20px auto;">
                                    <div class="pcat">
                                        <a href="Website-FNA-05" class="pcat__item" data-type="protection">
                                        <div class="pcat__inner">
                                            <div class="pcat__icon">
                                                <img src="assets/icon-marry.png">
                                            </div>
                                        ...
                                        <a href="Website-FNA-05" class="pcat__item" data-type="saving">
                                        <div class="pcat__inner">
                                            <div class="pcat__icon">
                                                <img src="assets/icon-single.png">
                                            </div>
                                            <div class="pcat__content">
                                            <span>โสด</span>
                                            </div>
                                        ...
                                        <a href="Website-FNA-05" class="pcat__item" data-type="saving">
                                            <div class="pcat__inner">
                                                <div class="pcat__icon">
                                                    <img src="assets/icon-divorced.png">
                                                </div>
                                                <div class="pcat__content">
                                                <span>แยกกันอยู่<br/>หรือหย่าร้าง</span>
                                                </div>
                                            </div>
                                        </a>
                                    </div>
