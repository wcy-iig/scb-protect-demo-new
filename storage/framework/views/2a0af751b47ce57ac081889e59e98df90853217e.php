...
<nav id="main-nav" class="nav-container">
        ...
        <div class="nmaxs">
            <div class="tac-container-1">
                <div class="nav-max-inner">
                    <a href="online_premium_cal" class="nmaxs__logo mx-auto">
    ...
    <div class="nav-min">
        <div class="nav-min-sticky nms">
            <a href="online_premium_cal" class="nms__logo mx-auto">
                <img src="/assets/img/logo-scb-protect-long.png" alt="SCB Protect Logo">
            </a>
        </div>
    </div>
                        ...
                        <div class="feat-inner">
                            ...
                            <div class="feat-content">
                                ...
                                <div class="buttons text-center pt-2">
                                    <a class="btn btn-primary-flat" href="Website-FNA">
...
<?php /**PATH /var/www/scb-protect-demo/resources/views/online_purchase_success.blade.php ENDPATH**/ ?>