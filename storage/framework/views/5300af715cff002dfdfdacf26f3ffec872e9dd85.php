        ...
        <div class="scroll-content-inner">
            <section class="sec-buy-insurance">
                ...
                <div class="tac-container-2 form-buy-ins-cnt">
                    <h2 class="title-section">ลูกแพรสวัสดีค่ะ</h2>
                    ...
                    <form id="formBuyInsurance" novalidate="novalidate" class="text-center">
                        <!-- <div class="form-group col-12 col-lg-6" style="margin: 0 auto;">
                            <input type="text" class="form-control" name="name" placeholder="ฉันชื่อ"
...
<?php /**PATH /var/www/scb-protect-demo/resources/views/Website-FNA-01.blade.php ENDPATH**/ ?>