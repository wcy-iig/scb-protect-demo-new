    ...
    <div class="scroll-content">
        <div class="scroll-content-inner">
            ...
            <section class="sec-buy-insurance">
                <div class="tac-container-1">
                    <a href="Website-FNA-06" class="back" style="position: absolute;"><img src="assets/icon-back.png"></a>
                ...
                <div class="tac-container-2 form-buy-ins-cnt">
                    <h2 class="title-section">รายได้ต่อเดือนคะ?</h2>
                    <br/>
                    <form id="formBuyInsurance" novalidate="novalidate">

                        <div class="form-group text-left col-12 col-lg-6 offset-lg-3">
                            <select data-placeholder="เดือน" id="topic" name="topic"
                                ...
                                <option>15,001 - 20,000 บาท</option>
                                <option>20,001 - 25,000 บาท</option>
                                <option>25,001 - 30,000 บาท</option>
                                <option>30,001 - 40,000 บาท</option>
                                <option>40,001 - 50,000 บาท</option>
                                <option>มากกว่า 50,001 บาท</option>

                            </select>
                        </div>

                        <div class="form-buttons">
                            <a href="Website-FNA-08" class="btn btn-secondary btn-anim-up" role="button" aria-disabled="true">ถัดไป</a>
                        </div>
                    </form>
                </div>
            </section>
