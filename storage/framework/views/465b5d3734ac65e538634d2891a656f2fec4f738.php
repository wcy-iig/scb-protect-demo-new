        ...
        <div class="scroll-content-inner">
            ...
            <section class="sec-buy-insurance">
                ...
                <div class="tac-container-2 form-buy-ins-cnt">
                    <h2 class="title-section">ขอทราบวันเกิดคะ?</h2>
                    <br/>
                    <form id="formBuyInsurance" novalidate="novalidate">
                        <div class="form-group text-left col-12 col-lg-3">
                            <input type="text" class="form-control" name="name" placeholder="วันที่"
                                   data-rule-required="true" data-msg-required="กรุณากดกรอกข้อมูล">
                        </div>
                        <div class="form-group text-left col-12 col-lg-5">
                        ...
                        <div class="form-group text-left col-12 col-lg-4">
                            <select data-placeholder="ปี" id="contact_time" name="contact_time"
                                    class="form-control select2-hidden-accessible" data-rule-required="true"
                                    data-msg-required="กรุณาใส่ข้อมูล" data-select2-id="select2-data-contact_time"
                                    tabindex="-1" aria-hidden="true">
